...
export default function ForteTeamMembersPage() {
  const { teamId } = useParams<{ teamId: string }>();

  return (
    <div>
      <div className="px-8 pt-6">
        <Link href="/admin/forte/team" className="inline-flex items-center gap-1.5 text-sm text-muted hover:text-foreground">
