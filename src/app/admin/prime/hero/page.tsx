...
export default function PrimeHeroPage() {
  ...
  async function handleSave() {
    ...
    const { error: err } = await supabase.from("hero_content").upsert({ ...rest, event_slug: "prime" }, { onConflict: "event_slug" });
  ...
  const fields = [
    ...
    { key: "date_text", label: "Data", placeholder: "29.07.2026" },
    { key: "city", label: "Oraș", placeholder: "Bistrița" },
    { key: "description", label: "Descriere", type: "textarea", placeholder: "BNI Prime te invită..." },
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <h1 className="mt-1 text-2xl font-bold text-foreground">Hero — Secțiunea principală</h1>
        <p className="mt-1 text-sm text-muted">Titlul, data, descrierea și imaginea din prima secțiune a paginii.</p>
      </div>
