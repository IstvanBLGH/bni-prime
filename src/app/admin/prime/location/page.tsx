...
export default function PrimeLocationPage() {
  ...
  async function handleSave() {
    ...
    const { error: err } = await supabase.from("location_content").upsert({ ...rest, event_slug: "prime" }, { onConflict: "event_slug" });
  ...
  const fields = [
    { key: "venue_name", label: "Nume locație", placeholder: "Hotel Codrișor" },
    { key: "address", label: "Adresă", placeholder: "Str. Codrișor, nr. 28, Bistrița" },
