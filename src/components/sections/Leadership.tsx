...
const MEMBERS = [
  {
    ...
    role: "Servicii imobiliare",
    company: "ALLIANCE IMOBIL SOLUTION",
    website: "https://allianceimobil.ro",
    phone: "+40 726 756 733",
    photo: "/images/leadership/Alin Corcode.png",
  },
  {
    name: "Vasile Neagoș",
    role: "Avocat stagiar",
    company: "Neagoș Vasile-Teodor Avocat Stagiar",
    website: "https://morutan.ro",
    phone: "+40 769 216 621",
    photo: "/images/leadership/Vasile Neagoș.png",
  },
  {
    name: "Marius Lăzăroi",
    role: "Agenție de producție publicitară",
    company: "FAST DESIGN 2 PRINT",
    website: "",
    phone: "+40 745 932 851",
    photo: "",
  },
  {
    name: "Alexandru Antal",
    role: "Sisteme fotovoltaice",
    company: "PANOURI CLUJ",
    website: "https://panouricluj.ro",
    phone: "+40 753 859 864",
    photo: "/images/leadership/Alexandru Antal.png",
  },
  {
    name: "Monica Mariana Mutu",
    role: "Centru energetic",
    company: "PERSOANĂ FIZICĂ AUTORIZATĂ",
    website: "",
    phone: "+40 767 920 313",
    photo: "/images/leadership/Monica Mutu.png",
  },
  {
    name: "Lucica Ana Marta",
    role: "Servicii de recrutare",
    company: "EUROPX BEST SOLUTIONS",
    website: "https://recrutare-smart.ro",
    phone: "+40 751 054 283",
    photo: "/images/leadership/Lucica Marta.png",
  },
  {
    name: "Mariana-Dacina Silvesan-Gherman",
    role: "Izolații naturale",
    company: "SIMAD 2016",
    website: "https://izolatiitermice.eu",
    phone: "+40 745 549 863",
    photo: "/images/leadership/Dacina Silveșan.png",
  },
  {
    name: "Bogdan Szilagyi",
    role: "Servicii topografice",
    company: "MAPCAD PROIECT",
    website: "https://mapcadproiect.ro",
    phone: "+40 741 421 580",
    photo: "/images/leadership/Bogdan Szilagyi.png",
  },
  {
    name: "Horia Ștefănescu",
    role: "Birotică și papetărie",
    company: "PAPERLAND",
    website: "",
    phone: "+40 731 352 170",
  ...
  },
  {
    name: "Salim Mroue",
    role: "",
    company: "NOMAD COFFEE COCOA",
    website: "https://nomcoco.com",
    phone: "+40 752 482 492",
    photo: "/images/leadership/Salim Mroue.png",
  },
];
